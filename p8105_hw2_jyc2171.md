...
in the “precip\_df” with 3 columns and 24 rows. The total precipitation
in 2018 was `sum(precip_2018, col(total)` inches.
...
There are a total of 416 rows in our final dataset.
